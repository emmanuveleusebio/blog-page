...
const CardPost = ({data}) => {
   ...
   return(
    ...
    <Card.Title className={CardCss.titleDescription}>{data.titleDescription}<span> {data.date}</span></Card.Title>
    ...
    <div className={CardCss.footer}>
      <Button variant="primary" onClick={toggleReadMore}>{isReadMore ? (<>Read More <i class="fa-solid fa-angles-right"></i></>) : (<><i class="fa-solid fa-angles-left"></i> Read Less</>)}</Button>
